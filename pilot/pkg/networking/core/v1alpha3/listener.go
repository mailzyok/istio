	...
	if sidecarScope == nil || sidecarScope.Config == nil {
		...
		for _, service := range services {
			for _, servicePort := range service.Ports {
				...
				configgen.buildSidecarOutboundListenerForPortOrUDS(listenerOpts, pluginParams, listenerMap, virtualServices, actualWildcard)
			}
		}
	} else {
...
func (configgen *ConfigGeneratorImpl) buildSidecarOutboundListenerForPortOrUDS(listenerOpts buildListenerOpts,
	pluginParams *plugin.InputParams, listenerMap map[string]*outboundListenerEntry, virtualServices []model.Config, actualWildcard string) {
